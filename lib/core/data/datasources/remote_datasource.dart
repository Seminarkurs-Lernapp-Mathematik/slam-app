...
class RemoteDataSource {
  ...
  Future<Result<Map<String, dynamic>?, AppError>> getUser(String userId) async {
    try {
      ...
      return Failure(DatabaseError('Failed to get user: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  }

  Future<Result<void, AppError>> updateUser(
    ...
    try {
      ...
      return Failure(DatabaseError('Failed to update user: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<void, AppError>> setUser(
      String userId, Map<String, dynamic> data) async {
    try {
      await _firestore
          .collection(FirebaseCollections.users)
      ...
      return Failure(DatabaseError('Failed to set user: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<Map<String, dynamic>?, AppError>> getLernplan(
      String userId) async {
    try {
      final doc = await _firestore
          .collection(FirebaseCollections.users)
      ...
      return Failure(DatabaseError('Failed to get lernplan: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<void, AppError>> updateLernplan(
      String userId, Map<String, dynamic> data) async {
    try {
      await _firestore
          .collection(FirebaseCollections.users)
      ...
      return Failure(DatabaseError('Failed to update lernplan: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<Map<String, dynamic>?, AppError>> getSettings(
      String userId) async {
    try {
      final doc = await _firestore
          .collection(FirebaseCollections.users)
      ...
      return Failure(DatabaseError('Failed to get settings: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<void, AppError>> updateSettings(
    ...
    try {
      ...
      return Failure(DatabaseError('Failed to update settings: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<Map<String, dynamic>?, AppError>> getStats(
      String userId) async {
    try {
      final doc = await _firestore
          .collection(FirebaseCollections.users)
      ...
      return Failure(DatabaseError('Failed to get stats: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<void, AppError>> updateStats(
      String userId, Map<String, dynamic> data) async {
    try {
      await _firestore
          .collection(FirebaseCollections.users)
      ...
      return Failure(DatabaseError('Failed to update stats: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<T, AppError>> runTransaction<T>(
    ...
    try {
      ...
      return Failure(DatabaseError('Transaction failed: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
  ...
  Future<Result<void, AppError>> commitBatch(
    ...
    try {
      ...
      return Failure(DatabaseError('Batch failed: ${e.message}',
          code: e.code, stackTrace: st));
    } catch (e, st) {
      return Failure(NetworkError('Network error: $e', stackTrace: st));
    }
